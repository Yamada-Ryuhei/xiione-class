		...
		<div className="z-1  relative h-auto lg:h-[83vh] lg:overflow-hidden">
			...
			<div className="flex flex-col justify-center items-center">
				...
				<div
					...
					<div className="flex-col">
						<BorderStruktur Jabatan="Bendahara" Nama="Nuraeni" Width="120px" />
						<div className="py-[3%]"></div>
						<BorderStruktur Jabatan="" Nama="Bella" Width="120px" />
					</div>
				</div>
				...
				<div
					...
					<div className="flex-col">
						<BorderStruktur Jabatan="Keamanan" Nama="Nesha" Width="120px" />
						<div className="py-[3%]"></div>
						<BorderStruktur Jabatan="" Nama="-" Width="120px" />
					</div>

					<div className="flex-col">
						<BorderStruktur Jabatan="Kebersihan" Nama="Rajib" Width="120px" />
						<div className="py-[3%]"></div>
						<BorderStruktur Jabatan="" Nama="-" Width="120px" />
					</div>

					<div className="flex-col hidden lg:flex">
						<BorderStruktur Jabatan="Kerohanian" Nama="Didin" Width="120px" />
						<div className="py-[3%]"></div>
						<BorderStruktur Jabatan="" Nama="Alfi" Width="120px" />
					</div>
				</div>
