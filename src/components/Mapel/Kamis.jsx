	...
	return (
		<>
			<div
				...
				<div className="flex justify-center items-center text-sm">2 JAM</div>
			</div>
			<div
				...
				<div className="flex justify-center items-center text-sm">3 JAM</div>
			</div>
			<div
				className="border-t-2 border-b-2 border-white flex justify-between py-[0.50rem] w-72 px-3"
				data-aos="fade-up"
			...
			<div
				...
				<div className="w-[50%] text-base  font-medium">B.Jepang</div>
				<div className="flex justify-center items-center text-sm">2 JAM</div>
			</div>
		</>
	)
